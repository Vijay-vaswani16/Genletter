...
function App() {
  ...
  const [resumeType,setResumeType]= useState(1);
    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route
          ...
          element={user ? (resumeType===1? <Resume1 onSetResumeType={(value)=>setResumeType(value)} />:<Resume2 onSetResumeType={(value)=>setResumeType(value)}/>) : <Navigate to="/login" />}
        />
        <Route
          exact
